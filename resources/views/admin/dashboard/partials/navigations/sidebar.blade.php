                ...
                <ul class="mb-6 flex flex-col gap-1.5">
                    ...
                    <li>
                        <a class="group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-active dark:hover:bg-meta-4"
                            ...
                            :class="page.includes('report') ? 'bg-active dark:bg-meta-4' : ''">
                    ...
                    <li>
                        <a class="group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-active dark:hover:bg-meta-4"
                            href="{{ route('viewFeedback') }}" @click="selected = (selected === 'Chart' ? '':'Chart')"
                            :class="page.includes('feedback') ? 'bg-active dark:bg-meta-4' : ''">
                            <svg class="fill-current" width="18" height="19" viewBox="0 0 18 19" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <g clip-path="url(#clip0_130_9801)">
                                    <path

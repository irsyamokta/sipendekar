...
<form id="sdq-form" action="{{ route('editSDQSecond', $data->id_sdq) }}" method="POST" enctype="multipart/form-data">
    @csrf
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="{{ route('sdqSecond') }}"
                            class="ms-1 text-sm font-medium text-gray-700 hover:text-secondary md:ms-2 dark:text-gray-400 dark:hover:text-white">SDQ 11 - 18 Tahun</a>
                    </div>
                </li>

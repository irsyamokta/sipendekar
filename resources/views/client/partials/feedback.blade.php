...
<body class="bg-gradient-to-t from-soft to-white to-16%">
    <section class="md:h-[100vh] flex flex-col md:flex lg:flex-row">
        ...
        <div class="w-full lg:w-1/2 flex flex-col justify-center items-center py-10 gap-10">
            ...
            <div class="flex flex-col justify-center items-center gap-5 bg-white px-20 py-10 rounded-lg shadow-sm">
                    ...
                    <div class="flex flex-col justify-center items-center">
                        <div class="mb-5">
                            ...
                            <input type="text" name="name" value="{{ old('name') }}" required
                                ...
                                class="rounded-lg w-[250px] lg:w-[300px] placeholder:text-xs placeholder:text-[#C4C4C4] md:placeholder:text-sm">
                        </div>
                        <div class="mb-5">
                            ...
                            <textarea type="text" rows="4" name="feedback" required placeholder="Deskripsikan pengalaman Anda"
                                class="rounded-lg w-[250px] lg:w-[300px] placeholder:text-xs placeholder:text-[#C4C4C4] md:placeholder:text-sm">{{ old('feedback') }}</textarea>
                        </div>
                        <button
                ...
                <p class="mt-5 text-xs text-secondary font-regular">Copyright © SiPendekar {{ date('Y') }}. All
                    Right
                    Reserves</p>
            </div>
        </div>

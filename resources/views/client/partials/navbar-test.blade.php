            ...
            <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 rounded-lg bg-white md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0  md:bg-transparent">
                <li>
                    <a href="{{ route('homepage') }}"
                        class="block py-2 px-3 text-gray-900 rounded hover:bg-primary md:hover:bg-transparent md:border-0 md:hover:text-soft md:p-0">Beranda</a>
                </li>
                <li>
                ...
                <li>
                    <a href="{{ route('homepage') }}#test"
                        class="block py-2 px-3 text-white bg-secondary rounded md:bg-transparent md:text-secondary md:font-bold md:p-0" aria-current="page">Tes</a>
                </li>
            </ul>
        </div>
    </div>
